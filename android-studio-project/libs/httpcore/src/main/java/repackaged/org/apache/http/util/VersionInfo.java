...
public class VersionInfo {
     ...
     *                  for example "repackaged.org.apache.http".
    ...
    public static VersionInfo loadVersionInfo(final String pckg,
        ...
        try {
            // repackaged.org.apache.http      becomes
     ...
     * @param pkg
     *            the package for which to load version information, for example "repackaged.org.apache.http". The package name
