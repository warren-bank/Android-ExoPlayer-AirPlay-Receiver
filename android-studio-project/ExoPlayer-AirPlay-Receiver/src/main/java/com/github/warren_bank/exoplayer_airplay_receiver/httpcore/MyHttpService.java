...
import repackaged.org.apache.http.UnsupportedHttpVersionException;
import repackaged.org.apache.http.entity.ByteArrayEntity;
import repackaged.org.apache.http.params.DefaultedHttpParams;
...
import repackaged.org.apache.http.protocol.HttpRequestHandlerResolver;
import repackaged.org.apache.http.util.EncodingUtils;
...
public class MyHttpService {
  ...
  public MyHttpService(final HttpProcessor proc, final ConnectionReuseStrategy connStrategy, final HttpResponseFactory responseFactory) {
    super();
  ...
  public void handleRequest(final HttpServerConnection conn, final HttpContext context) throws IOException, HttpException {
    ...
    try {
      ...
      if ("200".equals(method)) {
        Log.d(tag, "airplay in HTTPService, Receive iOS HTTP reverse response 200 OK, do nothing just return");
        return;
      }
      if (context.getAttribute("NO-RESP") != null) {
        Log.d(tag, "airplay in HTTPService, get /playback-info response this time!!");
