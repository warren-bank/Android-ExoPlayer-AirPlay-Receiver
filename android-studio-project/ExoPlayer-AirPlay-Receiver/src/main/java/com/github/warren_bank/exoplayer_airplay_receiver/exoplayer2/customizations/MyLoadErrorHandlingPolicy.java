...
public class MyLoadErrorHandlingPolicy extends DefaultLoadErrorHandlingPolicy {
  ...
  // ===========================================================================
  // https://github.com/androidx/media/blob/1.5.0/libraries/exoplayer/src/main/java/androidx/media3/exoplayer/upstream/DefaultLoadErrorHandlingPolicy.java#L118
  // https://github.com/androidx/media/blob/1.5.0/libraries/exoplayer/src/main/java/androidx/media3/exoplayer/upstream/LoadErrorHandlingPolicy.java#L76
  // https://github.com/androidx/media/blob/1.5.0/libraries/exoplayer/src/main/java/androidx/media3/exoplayer/source/LoadEventInfo.java
  // https://github.com/androidx/media/blob/1.5.0/libraries/exoplayer/src/main/java/androidx/media3/exoplayer/source/MediaLoadData.java
  // ===========================================================================
