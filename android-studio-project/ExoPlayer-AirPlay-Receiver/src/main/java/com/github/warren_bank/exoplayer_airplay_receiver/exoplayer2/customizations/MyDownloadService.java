...
/*
 * based on:
 *   https://github.com/androidx/media/blob/1.11.0/demos/main/src/main/java/androidx/media3/demo/main/DemoDownloadService.java
 */
...
public class MyDownloadService extends DownloadService {
  ...
  public MyDownloadService() {
    super(
        ...
        R.string.exo_download_notification_channel_name,  // https://github.com/androidx/media/blob/1.11.0/libraries/exoplayer/src/main/res/values/strings.xml#L20
  ...
  protected Scheduler getScheduler() {
    return new PlatformScheduler(this, ResourceUtils.getInteger(/* context= */ this, R.integer.PLATFORM_SCHEDULER_JOB_ID_EXOPLAYER_DOWNLOAD_SERVICE));
  }
